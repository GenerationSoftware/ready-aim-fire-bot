/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7729a67bf6418a0d9db0a5a61c92dd01)
...
declare namespace Cloudflare {
	interface Env {
		...
		OPERATOR_MANAGER: DurableObjectNamespace<import("./src/index").OperatorManager>;
		CHARACTER_OPERATOR: DurableObjectNamespace<import("./src/index").CharacterOperator>;
		BATTLE_OPERATOR: DurableObjectNamespace<import("./src/index").BattleOperator>;
		ZIGGURAT_OPERATOR: DurableObjectNamespace<import("./src/index").ZigguratOperator>;
	}
}
